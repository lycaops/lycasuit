    ...
    <main className="flex min-h-dvh items-stretch bg-[#f4f7fb]">
      ...
      <div className="flex w-full items-center justify-center px-5 py-10 sm:px-8 lg:w-[55%] xl:w-1/2">
        <div className="w-full max-w-md">
          <div className="relative mb-8 flex h-32 items-center gap-3 overflow-hidden rounded-2xl bg-[#21264e] px-5 lg:hidden">
            <img src="/h2.svg" alt="" aria-hidden="true" className="pointer-events-none absolute -right-10 -top-14 h-40 w-40 opacity-20" />
            <img src="/h1.svg" alt="" aria-hidden="true" className="pointer-events-none absolute -bottom-16 -left-12 h-44 w-44 opacity-15" />
            <div className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-white p-1">
              <img src="/icons/icon-192.png" alt="" aria-hidden="true" className="h-full w-full object-contain" />
            </div>
            <img src="/logo.png" alt="LycaOps" className="relative h-8 w-auto max-w-[190px] object-contain" />
          </div>
          {children}
        </div>
      </div>
