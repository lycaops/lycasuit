    ...
    <div className="min-h-screen bg-[#f4f7fb] flex">
      ...
      >
        ...
        <div className="px-3 py-4 border-t border-white/10">
          ...
          <button onClick={() => logout(true)} className="mt-3 flex w-full items-center gap-2 rounded-lg px-1 py-2 text-sm text-white/60 hover:bg-white/10 hover:text-white">
