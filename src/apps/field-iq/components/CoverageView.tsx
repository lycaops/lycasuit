...
export default function CoverageView({ user }: { user: RpaUser }) {
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="sticky top-[calc(3.5rem+env(safe-area-inset-top))] md:top-0 z-30 -mx-4 mb-3 flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 bg-white/95 px-4 py-3 shadow-sm backdrop-blur md:mx-0 md:rounded-2xl md:border md:p-4">
        <button
