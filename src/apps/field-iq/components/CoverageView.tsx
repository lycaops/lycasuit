...
export default function CoverageView({ user }: { user: RpaUser }) {
  ...
  return (
    <div className={`px-4 pb-4 pt-0 md:p-6 max-w-7xl mx-auto ${showMap ? 'space-y-0' : 'space-y-6'}`}>
      ...
      <div className="sticky top-[calc(3.5rem+env(safe-area-inset-top))] md:top-0 z-30 -mx-4 -mt-16 mb-0 flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 bg-white/95 px-4 py-3 shadow-sm backdrop-blur md:mx-0 md:mt-0 md:mb-3 md:rounded-2xl md:border md:p-4">
        <button
