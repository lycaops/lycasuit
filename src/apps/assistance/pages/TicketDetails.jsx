    ...
    <div className="space-y-5 max-w-4xl mx-auto">
      ...
      <Card className="border-0 shadow-lg rounded-2xl py-0 overflow-hidden">
        <div className="relative overflow-hidden bg-foreground p-5 sm:p-6">
          <img src="/h2.svg" alt="" aria-hidden="true" className="pointer-events-none absolute -right-10 -top-6 h-32 w-32 opacity-20" />
          <img src="/h1.svg" alt="" aria-hidden="true" className="pointer-events-none absolute -right-8 top-8 h-32 w-32 opacity-[.15]" />
